    ...
    <section className="relative h-[78vh] flex flex-col items-center justify-center px-6 overflow-hidden bg-[#333333]">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto mt-2">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 mb-10 animate-fade-up rounded-full transition-shadow duration-300 ease-out hover:shadow-[0_0_15px_rgba(208,240,192,0.25),0_0_30px_rgba(208,240,192,0.15)]"
          style={{
